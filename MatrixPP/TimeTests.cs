...
class TimeTest
{
    ...
    public static void PowerForAll(uint count_iterations, uint[] min_dimention, uint[] max_dimention, int power)
    {
        InstanceThreadPool thread_pool = new InstanceThreadPool(4, Name: "Обработчик матриц");
    ...
    public static void PowerForParallel(uint count_iterations, uint[] min_dimention, uint[] max_dimention, int power)
    {
        InstanceThreadPool thread_pool = new InstanceThreadPool(4, Name: "Обработчик матриц");
